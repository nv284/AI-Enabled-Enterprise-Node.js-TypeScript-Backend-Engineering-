...
server.setRequestHandler(ListToolsRequestSchema, async () => {
    return {
        tools: [
            {
                name: "read_file",
                description: "Read the contents of any file on your computer. " +
            ...
            },
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        expression: {
                            type: "string",
                            description: "Math expression like '2 + 3 * 4' or '(100 / 5) - 2'",
                        },
                    },
                    required: ["expression"],
                },
            },
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        directory: {
                            type: "string",
                            description: "Directory path to list (e.g., ~/Desktop or ~/Documents)",
                        },
                    },
                    required: ["directory"],
                },
            ...
            try {
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: `❌ Error: Invalid math expression: ${e.message}`,
                        },
                    ],
                    isError: true,
                };
...
async function main() {
    ...
    console.error("🚀 [MCP Server] Started successfully. Waiting for Claude Desktop...");
}
// Run the server
main().catch((error) => {
