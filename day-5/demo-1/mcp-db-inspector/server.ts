...
type Database = import("sqlite").Database;
...
server.tool(
    "list_tables",
    "Lists all database tables available for inspection",
...
server.tool(
    "run_read_query",
    "Executes a safe SELECT query against the in-memory database to inspect data",
    {
